...
func (StreamPurposeRequest_Purpose) EnumDescriptor() ([]byte, []int) {
	return file_proto_qwrap_proto_rawDescGZIP(), []int{2, 0}
}
...
type GetFileMetadataResponse struct {
	...
	Metadata      *FileMetadata          `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`                             // Les métadonnées trouvées par l'agent (peut être nil si non trouvé)
	Found         bool                   `protobuf:"varint,4,opt,name=found,proto3" json:"found,omitempty"`                                  // True si l'agent a trouvé et peut servir ce fichier
...
const file_proto_qwrap_proto_rawDesc = "" +
	"\n" +
	"\x11proto/qwrap.proto\x12\vqwrap_proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"P\n" +
	"\x16GetFileMetadataRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x17\n" +
	"\afile_id\x18\x02 \x01(\tR\x06fileId\"\xc5\x01\n" +
	"\x17GetFileMetadataResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x19\n" +
	"\bagent_id\x18\x02 \x01(\tR\aagentId\x125\n" +
	"\bmetadata\x18\x03 \x01(\v2\x19.qwrap_proto.FileMetadataR\bmetadata\x12\x14\n" +
	"\x05found\x18\x04 \x01(\bR\x05found\x12#\n" +
	"\rerror_message\x18\x05 \x01(\tR\ferrorMessage\"\xeb\x02\n" +
...
var file_proto_qwrap_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_proto_qwrap_proto_goTypes = []any{
	...
	(*GetFileMetadataRequest)(nil),        // 5: qwrap_proto.GetFileMetadataRequest
	(*GetFileMetadataResponse)(nil),       // 6: qwrap_proto.GetFileMetadataResponse
	(*StreamPurposeRequest)(nil),          // 7: qwrap_proto.StreamPurposeRequest
	(*ByteRange)(nil),                     // 8: qwrap_proto.ByteRange
	(*FileMetadata)(nil),                  // 9: qwrap_proto.FileMetadata
	(*AgentRegistrationRequest)(nil),      // 10: qwrap_proto.AgentRegistrationRequest
	(*AgentRegistrationResponse)(nil),     // 11: qwrap_proto.AgentRegistrationResponse
	(*AgentHeartbeat)(nil),                // 12: qwrap_proto.AgentHeartbeat
	(*HeartbeatResponse)(nil),             // 13: qwrap_proto.HeartbeatResponse
	(*TransferOptions)(nil),               // 14: qwrap_proto.TransferOptions
	(*TransferRequest)(nil),               // 15: qwrap_proto.TransferRequest
	(*ChunkInfo)(nil),                     // 16: qwrap_proto.ChunkInfo
	(*ChunkAssignment)(nil),               // 17: qwrap_proto.ChunkAssignment
	(*TransferPlan)(nil),                  // 18: qwrap_proto.TransferPlan
	(*ClientReport)(nil),                  // 19: qwrap_proto.ClientReport
	(*ChunkTransferStatus)(nil),           // 20: qwrap_proto.ChunkTransferStatus
	(*UpdatedTransferPlan)(nil),           // 21: qwrap_proto.UpdatedTransferPlan
	(*RegisterForPlanUpdatesRequest)(nil), // 22: qwrap_proto.RegisterForPlanUpdatesRequest
	(*ChunkRequest)(nil),                  // 23: qwrap_proto.ChunkRequest
	(*ChunkErrorResponse)(nil),            // 24: qwrap_proto.ChunkErrorResponse
	nil,                                   // 25: qwrap_proto.FileMetadata.CustomAttributesEntry
	nil,                                   // 26: qwrap_proto.AgentHeartbeat.CustomMetricsEntry
	(*timestamppb.Timestamp)(nil),         // 27: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),           // 28: google.protobuf.Duration
}
var file_proto_qwrap_proto_depIdxs = []int32{
	9,  // 0: qwrap_proto.GetFileMetadataResponse.metadata:type_name -> qwrap_proto.FileMetadata
	4,  // 1: qwrap_proto.StreamPurposeRequest.purpose:type_name -> qwrap_proto.StreamPurposeRequest.Purpose
	1,  // 2: qwrap_proto.FileMetadata.checksum_algorithm:type_name -> qwrap_proto.ChecksumAlgorithm
	27, // 3: qwrap_proto.FileMetadata.last_modified:type_name -> google.protobuf.Timestamp
	25, // 4: qwrap_proto.FileMetadata.custom_attributes:type_name -> qwrap_proto.FileMetadata.CustomAttributesEntry
	28, // 5: qwrap_proto.AgentRegistrationResponse.heartbeat_interval:type_name -> google.protobuf.Duration
	27, // 6: qwrap_proto.AgentHeartbeat.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 7: qwrap_proto.AgentHeartbeat.status:type_name -> qwrap_proto.AgentStatus
	26, // 8: qwrap_proto.AgentHeartbeat.custom_metrics:type_name -> qwrap_proto.AgentHeartbeat.CustomMetricsEntry
	9,  // 9: qwrap_proto.TransferRequest.files_to_transfer:type_name -> qwrap_proto.FileMetadata
	14, // 10: qwrap_proto.TransferRequest.options:type_name -> qwrap_proto.TransferOptions
	8,  // 11: qwrap_proto.ChunkInfo.range:type_name -> qwrap_proto.ByteRange
	1,  // 12: qwrap_proto.ChunkInfo.checksum_algorithm:type_name -> qwrap_proto.ChecksumAlgorithm
	16, // 13: qwrap_proto.ChunkAssignment.chunk_info:type_name -> qwrap_proto.ChunkInfo
	27, // 14: qwrap_proto.ChunkAssignment.estimated_availability_time:type_name -> google.protobuf.Timestamp
	9,  // 15: qwrap_proto.TransferPlan.source_file_metadata:type_name -> qwrap_proto.FileMetadata
	17, // 16: qwrap_proto.TransferPlan.chunk_assignments:type_name -> qwrap_proto.ChunkAssignment
	14, // 17: qwrap_proto.TransferPlan.options:type_name -> qwrap_proto.TransferOptions
	27, // 18: qwrap_proto.ClientReport.report_timestamp:type_name -> google.protobuf.Timestamp
	20, // 19: qwrap_proto.ClientReport.chunk_statuses:type_name -> qwrap_proto.ChunkTransferStatus
	16, // 20: qwrap_proto.ChunkTransferStatus.chunk_info:type_name -> qwrap_proto.ChunkInfo
	2,  // 21: qwrap_proto.ChunkTransferStatus.event:type_name -> qwrap_proto.TransferEvent
	28, // 22: qwrap_proto.ChunkTransferStatus.transfer_duration:type_name -> google.protobuf.Duration
	17, // 23: qwrap_proto.UpdatedTransferPlan.new_or_updated_assignments:type_name -> qwrap_proto.ChunkAssignment
	16, // 24: qwrap_proto.UpdatedTransferPlan.invalidated_chunks:type_name -> qwrap_proto.ChunkInfo
	16, // 25: qwrap_proto.ChunkRequest.chunk_info_requested:type_name -> qwrap_proto.ChunkInfo
	3,  // 26: qwrap_proto.ChunkErrorResponse.error_code:type_name -> qwrap_proto.ChunkErrorCode
